...
st.set_page_config(page_title="SM Approval", page_icon="⏳", layout="wide")

# URL apps script
API_URL = "https://script.google.com/macros/s/AKfycbxnF79_8nSOYmPqFA8AbZ8gHYrOVYrqSn5NJRCvIPYoj_i2JnA6zEsZesxuCEYb-Pw/exec"

st.title("SM Approval")
        ...
        if id_to_update:
            ...
            if st.button("Update Data"):
                ...
                if response.status_code == 200:
                    ...
                    st.success(f"✅ Data berhasil diperbarui! (Last Update SM: {last_update_sm})")
